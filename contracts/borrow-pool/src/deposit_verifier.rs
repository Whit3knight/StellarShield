//! Groth16 verifier for the shielded-deposit circuit.
//!
...
//!
//! VK bytes generated by
//! `bun contracts/scripts/vk-json-to-bytes.ts …/shielded-deposit/build/verification_key.json src/vk/deposit`.
//! Keep the number of IC points aligned with `nPublic + 1 = 4`.
...
const VK_ALPHA: &[u8; 96] = include_bytes!("vk/deposit/vk_alpha.bin");
const VK_BETA: &[u8; 192] = include_bytes!("vk/deposit/vk_beta.bin");
const VK_GAMMA: &[u8; 192] = include_bytes!("vk/deposit/vk_gamma.bin");
const VK_DELTA: &[u8; 192] = include_bytes!("vk/deposit/vk_delta.bin");

const VK_IC_0: &[u8; 96] = include_bytes!("vk/deposit/vk_ic_0.bin");
const VK_IC_1: &[u8; 96] = include_bytes!("vk/deposit/vk_ic_1.bin");
const VK_IC_2: &[u8; 96] = include_bytes!("vk/deposit/vk_ic_2.bin");
const VK_IC_3: &[u8; 96] = include_bytes!("vk/deposit/vk_ic_3.bin");
