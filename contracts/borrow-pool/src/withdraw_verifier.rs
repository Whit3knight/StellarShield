//! Groth16 verifier for the shielded-withdraw circuit.
//!
...
const VK_ALPHA: &[u8; 96] = include_bytes!("vk/withdraw/vk_alpha.bin");
const VK_BETA: &[u8; 192] = include_bytes!("vk/withdraw/vk_beta.bin");
const VK_GAMMA: &[u8; 192] = include_bytes!("vk/withdraw/vk_gamma.bin");
const VK_DELTA: &[u8; 192] = include_bytes!("vk/withdraw/vk_delta.bin");

const VK_IC_0: &[u8; 96] = include_bytes!("vk/withdraw/vk_ic_0.bin");
const VK_IC_1: &[u8; 96] = include_bytes!("vk/withdraw/vk_ic_1.bin");
const VK_IC_2: &[u8; 96] = include_bytes!("vk/withdraw/vk_ic_2.bin");
const VK_IC_3: &[u8; 96] = include_bytes!("vk/withdraw/vk_ic_3.bin");
const VK_IC_4: &[u8; 96] = include_bytes!("vk/withdraw/vk_ic_4.bin");
