...
// Groth16 point encoding: soroban-sdk expects uncompressed BLS12-381
// points with a specific field order (G2: c0 || c1). Match verifier.rs
// exactly — one byte off and pairing_check returns false.
